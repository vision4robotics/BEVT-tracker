...
%   This script runs the original implementation of Background Effect-Aware Visual Tracking (BEVT) for visual tracking.
%   Some functions are borrowed from other papers (SRDCF, UAV123 Benchmark, etc)- and
